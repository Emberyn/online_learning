...
(1, '数据库高级设计', '学习触发器、存储过程与视图的实战应用', '掌握数据库高级特性开发', '第一章：视图...第二章：触发器...', '1. 视图 2. 触发器 3. 存储过程', 2, '计算机', 'published', 2, 1),
(2, 'Python Web实战', '基于Flask框架开发在线系统', '能够独立完成B/S架构系统开发', 'Flask路由、模板、数据库连接', '1. Flask基础 2. PyMySQL集成', 2, '计算机', 'published', 50, 0),
(3, '高等数学基础', '微积分与线性代数入门', '掌握极限与导数计算', '极限、导数、积分应用', '1. 极限计算 2. 导数基础', 3, '理学', 'pending', 60, 0);
